#generate stub and first predict, after this, use run_cycle 
#rm -rf stub_image
...
echo -e "\n\n\n****************************run verify *********************************"
python3 -m reflective_learning.tools.mini --mode verify --input predicted.json --output verified1.json --image stub_image --max-success-steps 15

echo -e "\n\n\n****************************run verify filter*********************************"
python3 filter3.py --filename verified1.json

echo -e "\n\n\n****************************run preprocess on verified *********************************"
python3 -m reflective_learning.tools.main preprocess --input verified.json --mapping ../jack_bot/motion_path/mapping_state16.txt --output verified1_preprocess.json  --context-dir context --image stub_image 

python3 filter3.py --filename verified1_preprocess.json
